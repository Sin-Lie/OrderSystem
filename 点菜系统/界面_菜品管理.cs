...
namespace 点菜系统
{
    public partial class DishManagementForm : Form
    {
        ...
        {
            XmlClass.modifyInfo($"菜品-{dishTypeToLoad}.xml", "Name", textBox10.Text, "Price", textBox9.Text);
        ...
        {
            XmlClass.modifyInfo($"菜品-{dishTypeToLoad}.xml", "Name", textBox11.Text, "OnOff", "是");
        ...
        {
            XmlClass.modifyInfo($"菜品-{dishTypeToLoad}.xml", "Name", textBox11.Text, "OnOff", "否");
        ...
        {
            dishTypeToLoad = toolStripLabel1.Text;
        ...
        {
            dishTypeToLoad = toolStripLabel2.Text;
        ...
        {
            dishTypeToLoad = toolStripLabel3.Text;
